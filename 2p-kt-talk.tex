...
\begin{frame}[allowframebreaks]{Main Sorts of \kt{Term}s}
    ...
    \begin{block}{The \kt{Struct} type is a sub-type of \kt{Term}}\centering\itshape
    ...
    \begin{block}{The \kt{Atom} type is a sub-type of both \kt{Struct} and \kt{Constant}}\centering\itshape
    ...
    \begin{block}{The \kt{Var} type is a sub-type of \kt{Term}}\centering\itshape
    ...
    \begin{description}
        ...
        \item[\kt{indicatedArity: Int?}] if $a$ is a non-negative integer, returns \kt{$n$.intValue.toInt()}, otherwise \kt{null}  
...
\begin{frame}[allowframebreaks]{Collections}
    ...
    \end{exampleblock}
    %
    \begin{block}{The \kt{Cpllection} type is a sub-type of \kt{Struct}}\centering\itshape
...
\begin{frame}[allowframebreaks]{The \kt{Unificator} type}
    interface + purpose + default functioning
\end{frame}
...
\begin{frame}[allowframebreaks]{Using \kt{Unificator}s}
    examples of custom unificators
