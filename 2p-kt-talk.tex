...
\begin{frame}[allowframebreaks]{Prolog-like Operators}
    \begin{block}{Definition}
        ...
        %
        \begin{description}
            \item[functor: String] i.e. the operator's symbol
            \item[priority: Int] where lower integers correspong to higher priorities
            %
            \begin{itemize}\small
                \item conventionally, 0 is \alert{max} priority, 1200 is \alert{min} priority
            \end{itemize}
            \item[specifier: Specifier] is a descriptor of the operator's
            %
            \begin{description}\small
