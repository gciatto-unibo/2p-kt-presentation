...
\begin{frame}[allowframebreaks]{The \kt{Substitution} Type Hierarchy}
    ...
    \begin{description}
        \item[\kt{isSuccess: Boolean}]
        \item[\kt{isFail: Boolean}]
        \item[\kt{getByName(String): Term?}] 
        \item[\kt{plus(Substitution): Substitution}] 
        \item[\kt{minus(\meta{Container}): Substitution}]
        \item[\kt{minus(Substitution): Substitution}]
        \item[\kt{filter(\meta{Container}): Substitution}] 
        \item[\kt{filter(\meta{Predicate}): Substitution}]  
    \end{description}
    %
    \begin{itemize}
...
\begin{frame}[allowframebreaks]{Collections Design}
    \begin{block}{Clause Collections}
        \begin{itemize}
            ...
            \item provide methods for addition, removal, and retrieval of clauses
