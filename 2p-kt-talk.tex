...
\begin{frame}[allowframebreaks]{The \kt{ClauseCollection} Type Hierarchy}
    ...
    \begin{description}
        ...
        \item[\kt{addLast(Clause): ClauseQueue}]  adds a clause in the \textit{last} position to the collection 
...
\begin{frame}[allowframebreaks]{Creating \kt{ClauseCollection}s}
    ...
    \kt{ClauseQueue} and \kt{ClauseMultiSet} provide two main static factories:
    %
    \begin{description}
