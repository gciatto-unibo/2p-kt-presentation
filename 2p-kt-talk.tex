...
\begin{frame}[allowframebreaks]{Creating \kt{TermFormatter}s}
    ...
    \begin{description}
        ...
        %
        \begin{itemize}\small
            \item \kt{VarFormat.UNDERSCORE}, \kt{OpFormat.IGNORE\_OPERATORS}, \kt{FuncFormat.QUOTED\_IF\_NECESSARY}
        ...
        %
        \begin{itemize}\small
            \item \kt{VarFormat.PRETTY}, \kt{OpFormat.EXPRESSIONS}, \kt{FuncFormat.QUOTED\_IF\_NECESSARY}
            \item \kt{numberVars = false}
        \end{itemize}    
...
\begin{frame}[allowframebreaks]{Formatting \kt{Term}s}
    \ktSnippet{snippets/MissingExample.kt}
\end{frame}
