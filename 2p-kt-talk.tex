...
\begin{frame}[allowframebreaks]{Main Sorts of \kt{Term}s}
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{img/constant.pdf}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{img/numeric.pdf}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{img/struct.pdf}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{img/atom.pdf}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{img/var.pdf}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{img/indicator.pdf}
    \end{center}
...
\begin{frame}[allowframebreaks]{Exceptions in \twopkt{}}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{img/exception.pdf}
    \end{center}
...
\begin{frame}[allowframebreaks]{The \kt{TermParser} Type}
    ...
    %
    \begin{description}
        \item[\kt{parseT(String): T}] parses a \kt{T} from a given string, using default operators
        \item[\kt{parseT(String, OperatorSet): T}] parses a \kt{T} from a given string, using the given operators
    \end{description}
    %
    with \kt{T} being a \kt{Term}, \kt{Struct}, \kt{Constant}, \kt{Var}, \kt{Atom}, \kt{Numeric}, \kt{Integer}, \kt{Real} or \kt{Clause}
