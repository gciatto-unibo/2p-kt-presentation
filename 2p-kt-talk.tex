...
\begin{frame}[allowframebreaks]{Overview on the OOP Lib Design}
    ...
    %
    \begin{enumerate}
        \item Two more sub-sorts of \kt{Atom}:
        %
        \begin{description}
            \item[\kt{ObjectRef}] | representing references to \alert{objects}
            \item[\kt{TypeRef}] | representing references to \alert{Type}s
            %
            \begin{itemize}
        ...
        %
        \plSnippet{snippets/new_object2.pl}
    \end{enumerate}
