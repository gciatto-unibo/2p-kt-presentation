...
\begin{frame}[allowframebreaks]{(De)Serialisation Overview}
    ...
    \begin{block}{\kt{Term} vs \kt{Theory} (de)serialisation}
        \begin{itemize}
            \item \textsc{2P-Kt}'s design tackles both single and multiple serialisation strategies
            \begin{itemize}
    ...
    \begin{block}{Supported MIME types}
        \begin{itemize}
            \item currently, (de)serialisation supports \kt{JSON}, \kt{YAML} and \kt{XML}
        \end{itemize}
    \end{block}
